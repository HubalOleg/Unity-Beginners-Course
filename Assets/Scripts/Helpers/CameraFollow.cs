...
public class CameraFollow : MonoBehaviour
{
	...
	[SerializeField]
	private float _smoothing = 5f;							//Amount of smoothing to apply to the cameras movement
	[SerializeField]
	private Vector3 _offset = new Vector3 (0f, 15f, -22f);	//The offset of the camera from the player (how far back and above the player the camera should be)
	...
	private void FixedUpdate ()
	{
		...
		var targetCamPos = _player.transform.position + _offset;
